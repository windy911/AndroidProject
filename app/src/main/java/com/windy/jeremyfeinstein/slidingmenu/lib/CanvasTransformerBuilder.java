...
public class CanvasTransformerBuilder {
	...
	private com.windy.jeremyfeinstein.slidingmenu.lib.SlidingMenu.CanvasTransformer mTrans;
	...
	private void initTransformer() {
		if (mTrans == null)
			mTrans = new com.windy.jeremyfeinstein.slidingmenu.lib.SlidingMenu.CanvasTransformer() {
			public void transformCanvas(Canvas canvas, float percentOpen) {	}
		};
	}

	public com.windy.jeremyfeinstein.slidingmenu.lib.SlidingMenu.CanvasTransformer zoom(final int openedX, final int closedX,
